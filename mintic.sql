...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-09-2021 a las 05:52:46
...
CREATE TABLE `clientes` (
  ...
  `IdMcpio` int(4) DEFAULT NULL,
  `IdVend` int(2) DEFAULT NULL,
  `IdEstado` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla que maneja los clientes activos de la empresa';

--
-- Volcado de datos para la tabla `clientes`
--

INSERT INTO `clientes` (`Nit`, `Cliente`, `Dir`, `Tel`, `Email`, `IdMcpio`, `IdVend`, `IdEstado`) VALUES
(9870519, 'JOHN ARREDONDO', 'CRA 14 104 89', '3426203', 'fredyarredondo@hotmail.com', 888, 1, 1);
...
CREATE TABLE `detallefactura` (
  ...
  `IdPrdcto` int(5) DEFAULT NULL,
  `Cantidad` int(4) DEFAULT NULL,
  `Total` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla que maneja los productos de cada garantia';

--
-- Volcado de datos para la tabla `detallefactura`
--

INSERT INTO `detallefactura` (`Numfact`, `IdPrdcto`, `Cantidad`, `Total`) VALUES
(1, 1, 10, 10000);
...
CREATE TABLE `estado` (
  ...
  `NomEstado` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `facturas` (
  ...
  `FechFact` date DEFAULT NULL,
  `FechVent` date DEFAULT NULL,
  `Plazo` int(3) DEFAULT NULL,
  `IdUser` int(2) DEFAULT NULL,
  `IdEstado` int(6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla que maneja las garantias de los Clientes';

--
-- Volcado de datos para la tabla `facturas`
--

INSERT INTO `facturas` (`Numfact`, `Nit`, `FechFact`, `FechVent`, `Plazo`, `IdUser`, `IdEstado`) VALUES
(1, 9870519, '2021-09-27', '2021-09-27', 30, 1, 1);
...
CREATE TABLE `municipios` (
  `IdMcpio` int(4) NOT NULL,
  `IdDpto` int(2) DEFAULT NULL,
  `NomMcpio` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla de municipios de Colombia';

--
-- Volcado de datos para la tabla `municipios`
--

INSERT INTO `municipios` (`IdMcpio`, `IdDpto`, `NomMcpio`) VALUES
(1, 1, 'Leticia'),
(2, 1, 'Puerto Nariño'),
(3, 2, 'Abejorral'),
(4, 2, 'Abriaquí'),
...
CREATE TABLE `productos` (
  `IdPrcto` int(5) NOT NULL,
  `Ref` varchar(30) DEFAULT NULL,
  `Descripcion` text DEFAULT NULL,
  `PreVent` int(8) DEFAULT NULL,
  `PreComp` int(8) DEFAULT NULL,
  `MonStock` int(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla que maneja los productos que mas garantias presentan en la empresa';

--
-- Volcado de datos para la tabla `productos`
--

INSERT INTO `productos` (`IdPrcto`, `Ref`, `Descripcion`, `PreVent`, `PreComp`, `MonStock`) VALUES
(1, 'C150', 'COCA COLA 150ML', 1500, 1000, 100);
...
CREATE TABLE `usuarios` (
  ...
  `TipUser` varchar(20) DEFAULT NULL,
  `IdEstado` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla de los usuarios del sistema de informacion SIGG';

--
-- Volcado de datos para la tabla `usuarios`
--

INSERT INTO `usuarios` (`IdUser`, `NomUser`, `Nick`, `Passwd`, `TipUser`, `IdEstado`) VALUES
(1, 'John Arredondo', 'jarredondo19', 'abcd123', 'vendedor', 1);
...
CREATE TABLE `vendedores` (
  ...
  `NomVend` varchar(40) DEFAULT NULL,
  `IdEstado` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabla de los vendedores de la empresa, los cuales estan asociados a cada cliente';

--
-- Volcado de datos para la tabla `vendedores`
--

INSERT INTO `vendedores` (`IdVend`, `NomVend`, `IdEstado`) VALUES
(1, 'John Arredondo', 1);
...
ALTER TABLE `clientes`
  ADD PRIMARY KEY (`Nit`) COMMENT '''Llave primaria''',
  ADD KEY `FKIndVend` (`IdVend`),
  ADD KEY `FKIdMcpio` (`IdMcpio`),
...
ALTER TABLE `detallefactura`
  ADD KEY `FKNumGtia` (`Numfact`),
  ADD KEY `FKPrcto` (`IdPrdcto`);
...
ALTER TABLE `facturas`
  ...
  ADD KEY `FKnit` (`Nit`),
  ADD KEY `FKEstado` (`IdEstado`),
  ADD KEY `FKUsuario` (`IdUser`);
...
--
ALTER TABLE `departamentos`
  MODIFY `IdDpto` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `clientes`
  ADD CONSTRAINT `Est` FOREIGN KEY (`IdEstado`) REFERENCES `estado` (`IdEstado`),
  ADD CONSTRAINT `Mcpio` FOREIGN KEY (`IdMcpio`) REFERENCES `municipios` (`IdMcpio`),
  ADD CONSTRAINT `Vend` FOREIGN KEY (`IdVend`) REFERENCES `vendedores` (`IdVend`);

--
-- Filtros para la tabla `detallefactura`
--
ALTER TABLE `detallefactura`
  ADD CONSTRAINT `idprcto` FOREIGN KEY (`IdPrdcto`) REFERENCES `productos` (`IdPrcto`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `numgtia` FOREIGN KEY (`Numfact`) REFERENCES `facturas` (`Numfact`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `facturas`
--
ALTER TABLE `facturas`
  ADD CONSTRAINT `Estados` FOREIGN KEY (`IdEstado`) REFERENCES `estado` (`IdEstado`) ON UPDATE CASCADE,
  ADD CONSTRAINT `nit` FOREIGN KEY (`Nit`) REFERENCES `clientes` (`Nit`) ON UPDATE CASCADE,
  ADD CONSTRAINT `usuarios` FOREIGN KEY (`IdUser`) REFERENCES `usuarios` (`IdUser`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `municipios`
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `FkIdDpto` FOREIGN KEY (`IdDpto`) REFERENCES `departamentos` (`IdDpto`);

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `estado` FOREIGN KEY (`IdEstado`) REFERENCES `estado` (`IdEstado`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `vendedores`
--
ALTER TABLE `vendedores`
  ADD CONSTRAINT `Estaodods` FOREIGN KEY (`IdEstado`) REFERENCES `estado` (`IdEstado`) ON UPDATE CASCADE;
COMMIT;
